namespace KafkaFlow.Configuration
{
    ...
    internal sealed class ConsumerConfigurationBuilder : IConsumerConfigurationBuilder
    {
        ...
        private Func<WorkersCountContext, Task<int>> workersCountCalculator;
        ...
        {
            this.workersCountCalculator = _ => Task.FromResult(workersCount);
            return this;
        }

        public IConsumerConfigurationBuilder WithWorkersCount(Func<WorkersCountContext, Task<int>> calculator)
        {
