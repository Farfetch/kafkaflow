namespace KafkaFlow.UnitTests.Admin.WebApi.Controllers
{
    ...
    public class TelemetryControllerTests
    {
        ...
        {
            this.mockTelemetryStorage = new Mock<ITelemetryStorage>();
            this.target = new TelemetryController(this.mockTelemetryStorage.Object);
        }
        ...
        public void GetTelemetry_ReturnsOkResultWithTelemetryResponse()
        {
           // Arrange
            ...
            this.mockTelemetryStorage.Setup(x => x.Get()).Returns(metrics);

            // Act
            var result = this.target.GetTelemetry() as ObjectResult;
