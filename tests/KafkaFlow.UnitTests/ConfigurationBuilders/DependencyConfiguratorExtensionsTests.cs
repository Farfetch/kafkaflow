...
namespace KafkaFlow.UnitTests.ConfigurationBuilders
{
    ...
    {
        private static IEnumerable<object[]> _methodsForAdd
        {
            get
            {
        ...
        private static IEnumerable<object[]> _methodsForTryAdd
        {
            get
            {
                yield return new object[]
        ...
        [TestMethod]
        [DynamicData(nameof(_methodsForAdd))]
        ...
        [TestMethod]
        [DynamicData(nameof(_methodsForTryAdd))]
